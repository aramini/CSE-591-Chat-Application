! function(root, factory) {
  "object" == typeof exports && "object" == typeof module ? module.exports = factory(require("react"), require("react-dom")) : "function" == typeof define && define.amd ? define(["react", "react-dom"], factory) : "object" == typeof exports ? exports.ReactDraggable = factory(require("react"), require("react-dom")) : root.ReactDraggable = factory(root.React, root.ReactDOM)
  ...
  return function(modules) {
    ...
    var _extends = Object.assign || function(target) {
      ...
      Draggable = function(_React$Component) {
        function Draggable() {
          ...
          return _temp = _this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Draggable)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this.state = {
            dragging: !1,
            dragged: !1,
            ...
            return shouldStart === !1 ? !1 : void _this.setState({
              dragging: !0,
              dragged: !0
            })
            ...
            if (_this.props.bounds) {
              ...
              newState.clientX += _this.state.slackX, newState.clientY += _this.state.slackY;
              var _getBoundPosition = (0, _positionFns.getBoundPosition)(_this, newState.clientX, newState.clientY),
                _getBoundPosition2 = _slicedToArray(_getBoundPosition, 2);
              newState.clientX = _getBoundPosition2[0], newState.clientY = _getBoundPosition2[1], newState.slackX = _this.state.slackX + (_clientX - newState.clientX), newState.slackY = _this.state.slackY + (_clientY - newState.clientY), uiEvent.position.left = _clientX, uiEvent.position.top = _clientY, uiEvent.deltaX = newState.clientX - _this.state.clientX, uiEvent.deltaY = newState.clientY - _this.state.clientY
            }
            var shouldUpdate = _this.props.onDrag(e, uiEvent);
            return shouldUpdate === !1 ? !1 : void _this.setState(newState)
          }, _this.onDragStop = function(e, coreEvent) {
            if (!_this.state.dragging) return !1;
            var shouldStop = _this.props.onStop(e, (0, _domFns.createUIEvent)(_this, coreEvent));
            return shouldStop === !1 ? !1 : ((0, _log2["default"])("Draggable: onDragStop: %j", coreEvent.position), void _this.setState({
              dragging: !1,
              slackX: 0,
              slackY: 0
            }))
        ...
        return _inherits(Draggable, _React$Component), _createClass(Draggable, [{
          ...
          value: function() {
            _reactDom2["default"].findDOMNode(this) instanceof SVGElement && this.setState({
              isElementSVG: !0
            })
          }
        }, {
          ...
          value: function() {
            ...
            this.state.isElementSVG ? svgTransform = (0, _domFns.createSVGTransform)(transformOpts) : style = (0, _domFns.createCSSTransform)(transformOpts), this.state.dragging && !isNaN(this.props.zIndex) && (style.zIndex = this.props.zIndex);
    ...
    Draggable.displayName = "Draggable", Draggable.propTypes = _extends({}, _DraggableCore2["default"].propTypes, {
      ...
      }), _react.PropTypes.string, _react.PropTypes.oneOf([!1])]),
      ...
      function classNames() {
        for (var classes = "", i = 0; i < arguments.length; i++) {
          ...
          if (arg) {
            ...
            if ("string" === argType || "number" === argType) classes += " " + arg;
            else if (Array.isArray(arg)) classes += " " + classNames.apply(null, arg);
            else if ("object" === argType)
              for (var key in arg) hasOwn.call(arg, key) && arg[key] && (classes += " " + key)
          }
        }
        return classes.substr(1)
      }
      var hasOwn = {}.hasOwnProperty;
      "undefined" != typeof module && module.exports ? module.exports = classNames : (__WEBPACK_AMD_DEFINE_RESULT__ = function() {
        return classNames
    ...
    function createCSSTransform(_ref) {
      ...
      return _getPrefix2["default"] && (out[_getPrefix2["default"] + "Transform"] = out.transform), out
    }
    ...
    function styleHacks() {
      var childStyle = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0];
      return _extends({
        touchAction: "none"
      }, childStyle)
    }
    ...
    var _shims = __webpack_require__(6),
      ...
      _reactDom2 = _interopRequireDefault(_reactDom),
      matchesSelectorFunc = "",
      userSelectStyle = ";user-select: none;";
    _getPrefix2["default"] && (userSelectStyle += "-" + _getPrefix2["default"].toLowerCase() + "-user-select: none;")
  }, function(module, exports) {
    "use strict";
    ...
    function dontSetMe(props, propName, componentName) {
      if (props[propName]) throw new Error("Invalid prop " + propName + " passed to " + componentName + " - do not set this, set it on the child.")
    }
    Object.defineProperty(exports, "__esModule", {
      value: !0
    }), exports.findInArray = findInArray, exports.isFunction = isFunction, exports.isNum = isNum, exports["int"] = int, exports.dontSetMe = dontSetMe
  }, function(module, exports) {
    "use strict";
    ...
    function generatePrefix() {
      ...
      return void 0 === pre || null === pre ? "" : "ms" === pre ? pre : void 0 === pre || null === pre ? "" : pre.slice(0, 1).toUpperCase() + pre.slice(1)
    }
    Object.defineProperty(exports, "__esModule", {
      value: !0
    }), exports.generatePrefix = generatePrefix, exports["default"] = generatePrefix()
  }, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    function getBoundPosition(draggable, clientX, clientY) {
      ...
      bounds = "string" == typeof bounds ? bounds : cloneBounds(bounds);
      var node = _reactDom2["default"].findDOMNode(draggable);
      if ("string" == typeof bounds) {
        var boundNode = void 0;
        if ("parent" === bounds) boundNode = node.parentNode;
        else if (boundNode = document.querySelector(bounds), !boundNode) throw new Error('Bounds selector "' + bounds + '" could not find an element.');
        var nodeStyle = window.getComputedStyle(node),
          boundNodeStyle = window.getComputedStyle(boundNode);
        bounds = {
      ...
      return (0, _shims.isNum)(bounds.right) && (clientX = Math.min(clientX, bounds.right)), (0, _shims.isNum)(bounds.bottom) && (clientY = Math.min(clientY, bounds.bottom)), (0, _shims.isNum)(bounds.left) && (clientX = Math.max(clientX, bounds.left)), (0, _shims.isNum)(bounds.top) && (clientY = Math.max(clientY, bounds.top)), [clientX, clientY]
    }
    ...
    Object.defineProperty(exports, "__esModule", {
      value: !0
    }), exports.getBoundPosition = getBoundPosition, exports.snapToGrid = snapToGrid, exports.canDragX = canDragX, exports.canDragY = canDragY, exports.getControlPosition = getControlPosition;
    var _react = __webpack_require__(2),
      _shims = (_interopRequireDefault(_react), __webpack_require__(6)),
      _reactDom = __webpack_require__(3),
      _reactDom2 = _interopRequireDefault(_reactDom),
      _domFns = __webpack_require__(5)
  }, function(module, exports, __webpack_require__) {
    ...
    var _slicedToArray = function() {
      ...
      DraggableCore = function(_React$Component) {
        function DraggableCore() {
          ...
          for (var _len = arguments.length, args = Array(_len), _key = 0; _len > _key; _key++) args[_key] = arguments[_key];
          return _temp = _this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(DraggableCore)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this.state = {
            dragging: !1,
            lastX: null,
            lastY: null
          }, _this.handleDragStart = function(e) {
            if (_this.props.onMouseDown(e), !_this.props.allowAnyClick && "number" == typeof e.button && 0 !== e.button) return !1;
            if (!(_this.props.disabled || _this.props.handle && !(0, _domFns.matchesSelector)(e.target, _this.props.handle) || _this.props.cancel && (0, _domFns.matchesSelector)(e.target, _this.props.cancel))) {
              e.targetTouches && _this.setState({
              ...
              var _getControlPosition = (0, _positionFns.getControlPosition)(e),
                ...
                coreEvent = (0, _domFns.createCoreEvent)(_this, clientX, clientY);
              (0, _log2["default"])("DraggableCore: handleDragStart: %j", coreEvent.position), (0, _log2["default"])("calling", _this.props.onStart);
              var shouldUpdate = _this.props.onStart(e, coreEvent);
              shouldUpdate !== !1 && (_this.setState({
                dragging: !0,
                lastX: clientX,
                lastY: clientY,
                scrollX: document.body.scrollLeft,
                scrollY: document.body.scrollTop
              }), (0, _domFns.addEvent)(document, "scroll", _this.handleScroll), (0, _domFns.addEvent)(document, dragEventFor.move, _this.handleDrag), (0, _domFns.addEvent)(document, dragEventFor.stop, _this.handleDragStop))
            }
            ...
            if (!e.targetTouches || e.targetTouches[0].identifier === _this.state.touchIdentifier) {
              ...
              if (Array.isArray(_this.props.grid)) {
                ...
                if (deltaX = _snapToGrid2[0], deltaY = _snapToGrid2[1], !deltaX && !deltaY) return;
              ...
              return shouldUpdate === !1 ? void _this.handleDragStop({}) : void _this.setState({
                lastX: clientX,
                lastY: clientY
              })
            }
          }, _this.handleDragStop = function(e) {
            if (_this.state.dragging && (!e.changedTouches || e.changedTouches[0].identifier === _this.state.touchIdentifier)) {
              _this.props.enableUserSelectHack && (0, _domFns.removeUserSelectStyles)();
              var _getControlPosition3 = (0, _positionFns.getControlPosition)(e),
                ...
                coreEvent = (0, _domFns.createCoreEvent)(_this, clientX, clientY);
              (0, _log2["default"])("DraggableCore: handleDragStop: %j", coreEvent.position), _this.setState({
                dragging: !1,
                lastX: null,
                lastY: null
              }), _this.props.onStop(e, coreEvent), (0, _log2["default"])("DraggableCore: Removing handlers"), (0, _domFns.removeEvent)(document, "scroll", _this.handleScroll), (0, _domFns.removeEvent)(document, dragEventFor.move, _this.handleDrag), (0, _domFns.removeEvent)(document, dragEventFor.stop, _this.handleDragStop)
            }
          }, _this.handleScroll = function(e) {
            var s = _this.state,
              x = document.body.scrollLeft,
              y = document.body.scrollTop,
              coreEvent = (0, _domFns.createCoreEvent)(_this);
            coreEvent.position.deltaX = x - s.scrollX, coreEvent.position.deltaY = y - s.scrollY, _this.setState({
    ...
    DraggableCore.displayName = "DraggableCore", DraggableCore.propTypes = {
